        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('update_schedule_setting') }}">
                        @csrf
                        <table class="table table-borderd">
                            ...
                            <tr>
                                <th>木曜日</th>
                                <td>
                                    <input type="radio" name="flag_thur" value="{{ $FLAG_OPEN }}" {{ ($setting->isOpenThursday()) ? 'checked' : '' }} id="flag_thur_open" />
                                    <label for="flag_thur_open">営業日</label>
                                    <input type="radio" name="flag_thur" value="{{ $FLAG_CLOSE }}" {{ ($setting->isCloseThursday()) ? 'checked' : '' }} id="flag_thur_close" />
                                    <label for="flag_thur_close">休み</label>
                                </td>
                            </tr>
                            <tr>
                                <th>金曜日</th>
